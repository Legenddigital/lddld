...
func (r FutureGetRawTransactionResult) Receive() (*lddlutil.Tx, error) {
	...
	return lddlutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := lddljson.NewGetRawTransactionCmd(hash, lddljson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*lddlutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*lddljson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult lddljson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := lddljson.NewGetRawTransactionCmd(hash, lddljson.Int(1))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*lddljson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*lddljson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := lddljson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*lddljson.TxRawResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []lddljson.TransactionInput,
	amounts map[lddlutil.Address]lddlutil.Amount, lockTime *int64, expiry *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToCoin()
	}
	cmd := lddljson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime, expiry)
	return c.sendCmd(cmd)
}

// CreateRawTransaction returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawTransaction(inputs []lddljson.TransactionInput,
	amounts map[lddlutil.Address]lddlutil.Amount, lockTime *int64, expiry *int64) (*wire.MsgTx, error) {
...
type SStxCommitOut struct {
	...
	CommitAmt  lddlutil.Amount
	ChangeAddr lddlutil.Address
	ChangeAmt  lddlutil.Amount
}
...
func (c *Client) CreateRawSStxAsync(inputs []lddljson.SStxInput,
	amount map[lddlutil.Address]lddlutil.Amount,
	...
	cmd := lddljson.NewCreateRawSStxCmd(inputs,
		convertedAmt,
		convertedCouts)
...
// and sending to the provided addresses.
func (c *Client) CreateRawSStx(inputs []lddljson.SStxInput,
	amount map[lddlutil.Address]lddlutil.Amount,
...
func (c *Client) CreateRawSSGenTxAsync(inputs []lddljson.TransactionInput,
	votebits uint16) FutureCreateRawSSGenTxResult {

	cmd := lddljson.NewCreateRawSSGenTxCmd(inputs, votebits)
	return c.sendCmd(cmd)
}

// CreateRawSSGenTx returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawSSGenTx(inputs []lddljson.TransactionInput,
...
func (c *Client) CreateRawSSRtxAsync(inputs []lddljson.TransactionInput, fee lddlutil.Amount) FutureCreateRawSSRtxResult {
	feeF64 := fee.ToCoin()
	cmd := lddljson.NewCreateRawSSRtxCmd(inputs, &feeF64)
	return c.sendCmd(cmd)
}

// CreateRawSSRtx returns a new SSR transactionm (revoking an sstx).
func (c *Client) CreateRawSSRtx(inputs []lddljson.TransactionInput, fee lddlutil.Amount) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	cmd := lddljson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	return c.sendCmd(cmd)
}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult lddljson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := lddljson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []lddljson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := lddljson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.sendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []lddljson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := lddljson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []lddljson.RawTxInput, privKeysWIF []string,
	...
	cmd := lddljson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		lddljson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawSSGenTxAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := lddljson.NewSignRawTransactionCmd(txHex, &[]lddljson.RawTxInput{},
		nil, lddljson.String("ssgen"))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address lddlutil.Address, skip,
	count int, reverse bool,
	filterAddrs []string) FutureSearchRawTransactionsResult {

	addr := address.EncodeAddress()
	verbose := lddljson.Int(0)
	prevOut := lddljson.Int(0)
	cmd := lddljson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address lddlutil.Address, skip, count int,
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*lddljson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*lddljson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address lddlutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
	filterAddrs *[]string) FutureSearchRawTransactionsVerboseResult {

	addr := address.EncodeAddress()
	verbose := lddljson.Int(1)
	prevOut := lddljson.Int(0)
	if includePrevOut {
		prevOut = lddljson.Int(1)
	}
	cmd := lddljson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
		prevOut, &reverse, filterAddrs)
	return c.sendCmd(cmd)
...
func (c *Client) SearchRawTransactionsVerbose(address lddlutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
	filterAddrs []string) ([]*lddljson.SearchRawTransactionsResult, error) {

...
func (c *Client) GenerateAsync(numBlocks uint32) FutureGenerateResult {
	cmd := lddljson.NewGenerateCmd(numBlocks)
...
func (c *Client) GetGenerateAsync() FutureGetGenerateResult {
	cmd := lddljson.NewGetGenerateCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetGenerateAsync(enable bool, numCPUs int) FutureSetGenerateResult {
	cmd := lddljson.NewSetGenerateCmd(enable, &numCPUs)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHashesPerSecAsync() FutureGetHashesPerSecResult {
	cmd := lddljson.NewGetHashesPerSecCmd()
	return c.sendCmd(cmd)
}
...
// information.
func (r FutureGetMiningInfoResult) Receive() (*lddljson.GetMiningInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoResult lddljson.GetMiningInfoResult
...
func (c *Client) GetMiningInfoAsync() FutureGetMiningInfoResult {
	cmd := lddljson.NewGetMiningInfoCmd()
	return c.sendCmd(cmd)
}

// GetMiningInfo returns mining information.
func (c *Client) GetMiningInfo() (*lddljson.GetMiningInfoResult, error) {
...
func (c *Client) GetNetworkHashPSAsync() FutureGetNetworkHashPS {
	cmd := lddljson.NewGetNetworkHashPSCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS2Async(blocks int) FutureGetNetworkHashPS {
	cmd := lddljson.NewGetNetworkHashPSCmd(&blocks, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS3Async(blocks, height int) FutureGetNetworkHashPS {
	cmd := lddljson.NewGetNetworkHashPSCmd(&blocks, &height)
	return c.sendCmd(cmd)
}
...
// data to work on.
func (r FutureGetWork) Receive() (*lddljson.GetWorkResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result lddljson.GetWorkResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetWorkAsync() FutureGetWork {
	cmd := lddljson.NewGetWorkCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetWork() (*lddljson.GetWorkResult, error) {
...
func (c *Client) GetWorkSubmitAsync(data string) FutureGetWorkSubmit {
	cmd := lddljson.NewGetWorkCmd(&data)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockTemplate) Receive() (*lddljson.GetBlockTemplateResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result.
	var gbt lddljson.GetBlockTemplateResult
...
func (c *Client) GetBlockTemplateAsync(req *lddljson.TemplateRequest) FutureGetBlockTemplate {
	cmd := lddljson.NewGetBlockTemplateCmd(req)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockTemplate(req *lddljson.TemplateRequest) (*lddljson.GetBlockTemplateResult, error) {
...
func (c *Client) SubmitBlockAsync(block *lddlutil.Block, options *lddljson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
	...
	cmd := lddljson.NewSubmitBlockCmd(blockHex, options)
	return c.sendCmd(cmd)
}

// SubmitBlock attempts to submit a new block into the Legenddigital network.
func (c *Client) SubmitBlock(block *lddlutil.Block, options *lddljson.SubmitBlockOptions) error {

...
func (r FutureGetTransactionResult) Receive() (*lddljson.GetTransactionResult, error) {
	...
	var getTx lddljson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := lddljson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*lddljson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]lddljson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := lddljson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]lddljson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := lddljson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.sendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]lddljson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := lddljson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]lddljson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]lddljson.ListUnspentResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []lddljson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := lddljson.NewListUnspentCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := lddljson.NewListUnspentCmd(&minConf, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := lddljson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []lddlutil.Address) FutureListUnspentResult {
	addrStrs := make([]string, 0, len(addrs))
	for _, a := range addrs {
		addrStrs = append(addrStrs, a.EncodeAddress())
	}

	cmd := lddljson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]lddljson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]lddljson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]lddljson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []lddlutil.Address) ([]lddljson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*lddljson.ListSinceBlockResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult lddljson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = lddljson.String(blockHash.String())
	}

	cmd := lddljson.NewListSinceBlockCmd(hash, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*lddljson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := lddljson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*lddljson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]lddljson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = lddljson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
			Tree: op.Tree,
		}
	}
	cmd := lddljson.NewLockUnspentCmd(unlock, outputs)
	return c.sendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []lddljson.TransactionInput
	...
	for i, input := range inputs {
		...
		ops[i] = wire.NewOutPoint(sha, input.Vout, input.Tree) // Legenddigital TODO
	}
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := lddljson.NewListLockUnspentCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddressAsync(address lddlutil.Address, amount lddlutil.Amount) FutureSendToAddressResult {
	addr := address.EncodeAddress()
	cmd := lddljson.NewSendToAddressCmd(addr, amount.ToCoin(), nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddress(address lddlutil.Address, amount lddlutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address lddlutil.Address,
	amount lddlutil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := lddljson.NewSendToAddressCmd(addr, amount.ToCoin(), &comment,
		&commentTo)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address lddlutil.Address, amount lddlutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress lddlutil.Address, amount lddlutil.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := lddljson.NewSendFromCmd(fromAccount, addr, amount.ToCoin(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress lddlutil.Address, amount lddlutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress lddlutil.Address, amount lddlutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := lddljson.NewSendFromCmd(fromAccount, addr, amount.ToCoin(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress lddlutil.Address, amount lddlutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress lddlutil.Address, amount lddlutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress lddlutil.Address,
	amount lddlutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[lddlutil.Address]lddlutil.Amount) FutureSendManyResult {
	convertedAmounts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToCoin()
	}
	cmd := lddljson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[lddlutil.Address]lddlutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[lddlutil.Address]lddlutil.Amount,
	...
	cmd := lddljson.NewSendManyCmd(fromAccount, convertedAmounts,
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[lddlutil.Address]lddlutil.Amount, minConfirms int,
...
func (c *Client) PurchaseTicketAsync(fromAccount string,
	spendLimit lddlutil.Amount, minConf *int, ticketAddress lddlutil.Address,
	numTickets *int, poolAddress lddlutil.Address, poolFees *lddlutil.Amount,
	expiry *int, ticketFee *lddlutil.Amount) FuturePurchaseTicketResult {
	...
	cmd := lddljson.NewPurchaseTicketCmd(fromAccount, spendLimit.ToCoin(),
		&minConfVal, &ticketAddrStr, &numTicketsVal, &poolAddrStr,
		&poolFeesFloat, &expiryVal, lddljson.String(""), &ticketFeeFloat)
...
func (c *Client) PurchaseTicket(fromAccount string,
	spendLimit lddlutil.Amount, minConf *int, ticketAddress lddlutil.Address,
	numTickets *int, poolAddress lddlutil.Address, poolFees *lddlutil.Amount,
	expiry *int, ticketChange *bool, ticketFee *lddlutil.Amount) ([]*chainhash.Hash, error) {
...
func (c *Client) SendToSStxAsync(fromAccount string,
	...
	convertedCouts := make([]lddljson.SStxCommitOut, len(couts))
	...
	cmd := lddljson.NewSendToSStxCmd(fromAccount, convertedAmounts,
...
func (c *Client) SendToSSGenAsync(fromAccount string,
	...
	cmd := lddljson.NewSendToSSGenCmd(fromAccount, ticketHashString,
...
func (c *Client) SendToSSRtxAsync(fromAccount string,
	...
	cmd := lddljson.NewSendToSSRtxCmd(fromAccount, ticketHashString, nil)
...
func (c *Client) SendToSSRtxCommentAsync(fromAccount string,
	...
	cmd := lddljson.NewSendToSSRtxCmd(fromAccount, ticketHashString, &comment)
...
func (r FutureAddMultisigAddressResult) Receive() (lddlutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return lddlutil.DecodeAddress(addr)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []lddlutil.Address, account string) FutureAddMultisigAddressResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := lddljson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []lddlutil.Address, account string) (lddlutil.Address, error) {
...
func (r FutureCreateMultisigResult) Receive() (*lddljson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes lddljson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []lddlutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := lddljson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.sendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []lddlutil.Address) (*lddljson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := lddljson.NewCreateNewAccountCmd(account)
	return c.sendCmd(cmd)
}
...
// address.
func (r FutureGetNewAddressResult) Receive() (lddlutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := lddljson.NewGetNewAddressCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNewAddressGapPolicyAsync(account string, gapPolicy GapPolicy) FutureGetNewAddressResult {
	cmd := lddljson.NewGetNewAddressCmd(&account, (*string)(&gapPolicy))
	return c.sendCmd(cmd)
}

// GetNewAddress returns a new address.
func (c *Client) GetNewAddress(account string) (lddlutil.Address, error) {
...
func (c *Client) GetNewAddressGapPolicy(account string, gapPolicy GapPolicy) (lddlutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (lddlutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := lddljson.NewGetRawChangeAddressCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawChangeAddress(account string) (lddlutil.Address, error) {
...
// Legenddigital address for receiving payments to the specified account.
func (r FutureGetAccountAddressResult) Receive() (lddlutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := lddljson.NewGetAccountAddressCmd(account)
	return c.sendCmd(cmd)
}

// GetAccountAddress returns the current Legenddigital address for receiving payments
// to the specified account.
func (c *Client) GetAccountAddress(account string) (lddlutil.Address, error) {
...
func (c *Client) GetAccountAsync(address lddlutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := lddljson.NewGetAccountCmd(addr)
	return c.sendCmd(cmd)
}

// GetAccount returns the account associated with the passed address.
func (c *Client) GetAccount(address lddlutil.Address) (string, error) {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]lddlutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]lddlutil.Address, 0, len(addrStrings))
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := lddljson.NewGetAddressesByAccountCmd(account)
	return c.sendCmd(cmd)
}

// GetAddressesByAccount returns the list of addresses associated with the
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]lddlutil.Address, error) {
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := lddljson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.sendCmd(cmd)
}
...
// about the given Legenddigital address.
func (r FutureValidateAddressResult) Receive() (*lddljson.ValidateAddressWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult lddljson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address lddlutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := lddljson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given Legenddigital address.
func (c *Client) ValidateAddress(address lddlutil.Address) (*lddljson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := lddljson.NewKeyPoolRefillCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := lddljson.NewKeyPoolRefillCmd(&newSize)
	return c.sendCmd(cmd)
}
...
func (r FutureListAccountsResult) Receive() (map[string]lddlutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]lddlutil.Amount)
	for k, v := range accounts {
		amount, err := lddlutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := lddljson.NewListAccountsCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccounts() (map[string]lddlutil.Amount, error) {
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := lddljson.NewListAccountsCmd(&minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]lddlutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (*lddljson.GetBalanceResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var balance lddljson.GetBalanceResult
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := lddljson.NewGetBalanceCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalance(account string) (*lddljson.GetBalanceResult, error) {
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := lddljson.NewGetBalanceCmd(&account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (*lddljson.GetBalanceResult, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (lddlutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := lddlutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := lddljson.NewGetReceivedByAccountCmd(account, nil)
	return c.sendCmd(cmd)
}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (lddlutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := lddljson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (lddlutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (lddlutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := lddljson.NewGetUnconfirmedBalanceCmd(&account)
	return c.sendCmd(cmd)
}

// GetUnconfirmedBalance returns the unconfirmed balance from the server for
// the specified account.
func (c *Client) GetUnconfirmedBalance(account string) (lddlutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (lddlutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address lddlutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := lddljson.NewGetReceivedByAddressCmd(addr, nil)
	return c.sendCmd(cmd)
...
// confirmations.
func (c *Client) GetReceivedByAddress(address lddlutil.Address) (lddlutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address lddlutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := lddljson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressMinConf(address lddlutil.Address, minConfirms int) (lddlutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]lddljson.ListReceivedByAccountResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []lddljson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := lddljson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]lddljson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := lddljson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]lddljson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := lddljson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]lddljson.ListReceivedByAccountResult, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]lddljson.ListReceivedByAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []lddljson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := lddljson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]lddljson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := lddljson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]lddljson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := lddljson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]lddljson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := lddljson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := lddljson.NewWalletPassphraseChangeCmd(old, new)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address lddlutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := lddljson.NewSignMessageCmd(addr, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address lddlutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address lddlutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := lddljson.NewVerifyMessageCmd(addr, signature, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address lddlutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*lddlutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return lddlutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address lddlutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := lddljson.NewDumpPrivKeyCmd(addr)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address lddlutil.Address) (*lddlutil.WIF, error) {
...
func (c *Client) ImportAddressAsync(address string) FutureImportAddressResult {
	cmd := lddljson.NewImportAddressCmd(address, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportAddressRescanAsync(address string, rescan bool) FutureImportAddressResult {
	cmd := lddljson.NewImportAddressCmd(address, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *lddlutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := lddljson.NewImportPrivKeyCmd(wif, nil, nil, nil)
	return c.sendCmd(cmd)
}

// ImportPrivKey imports the passed private key which must be the wallet import
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *lddlutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *lddlutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := lddljson.NewImportPrivKeyCmd(wif, &label, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *lddlutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *lddlutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := lddljson.NewImportPrivKeyCmd(wif, &label, &rescan, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *lddlutil.WIF, label string, rescan bool) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanFromAsync(privKeyWIF *lddlutil.WIF, label string, rescan bool, scanFrom int) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := lddljson.NewImportPrivKeyCmd(wif, &label, &rescan, &scanFrom)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescanFrom(privKeyWIF *lddlutil.WIF, label string, rescan bool, scanFrom int) error {
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := lddljson.NewImportPubKeyCmd(pubKey, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := lddljson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptAsync(script []byte) FutureImportScriptResult {
	...
	cmd := lddljson.NewImportScriptCmd(scriptStr, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptRescanAsync(script []byte, rescan bool) FutureImportScriptResult {
	...
	cmd := lddljson.NewImportScriptCmd(scriptStr, &rescan, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptRescanFromAsync(script []byte, rescan bool, scanFrom int) FutureImportScriptResult {
	...
	cmd := lddljson.NewImportScriptCmd(scriptStr, &rescan, &scanFrom)
	return c.sendCmd(cmd)
}
...
func (c *Client) AccountAddressIndexAsync(account string, branch uint32) FutureAccountAddressIndexResult {
	cmd := lddljson.NewAccountAddressIndexCmd(account, int(branch))
	return c.sendCmd(cmd)
}
...
func (c *Client) AccountSyncAddressIndexAsync(account string, branch uint32, index int) FutureAccountSyncAddressIndexResult {
	cmd := lddljson.NewAccountSyncAddressIndexCmd(account, int(branch), index)
	return c.sendCmd(cmd)
}
...
func (c *Client) RevokeTicketsAsync() FutureRevokeTicketsResult {
	cmd := lddljson.NewRevokeTicketsCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) AddTicketAsync(rawHex string) FutureAddTicketResult {
	cmd := lddljson.NewAddTicketCmd(rawHex)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddTicket(ticket *lddlutil.Tx) error {
...
func (r FutureFundRawTransactionResult) Receive() (*lddljson.FundRawTransactionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var infoRes lddljson.FundRawTransactionResult
...
func (c *Client) FundRawTransactionAsync(rawhex string, fundAccount string, options lddljson.FundRawTransactionOptions) FutureFundRawTransactionResult {
	cmd := lddljson.NewFundRawTransactionCmd(rawhex, fundAccount, &options)
	return c.sendCmd(cmd)
}

// FundRawTransaction Add inputs to a transaction until it has enough
// in value to meet its out value.
func (c *Client) FundRawTransaction(rawhex string, fundAccount string, options lddljson.FundRawTransactionOptions) (*lddljson.FundRawTransactionResult, error) {
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureGenerateVoteResult) Receive() (*lddljson.GenerateVoteResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes lddljson.GenerateVoteResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GenerateVoteAsync(blockHash *chainhash.Hash, height int64, sstxHash *chainhash.Hash, voteBits uint16, voteBitsExt string) FutureGenerateVoteResult {
	cmd := lddljson.NewGenerateVoteCmd(blockHash.String(), height, sstxHash.String(), voteBits, voteBitsExt)
	return c.sendCmd(cmd)
}

// GenerateVote returns hex of an SSGen.
func (c *Client) GenerateVote(blockHash *chainhash.Hash, height int64, sstxHash *chainhash.Hash, voteBits uint16, voteBitsExt string) (*lddljson.GenerateVoteResult, error) {
	return c.GenerateVoteAsync(blockHash, height, sstxHash, voteBits, voteBitsExt).Receive()
}

// NOTE: While getinfo is implemented here (in wallet.go), a lddld chain server
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureGetInfoResult) Receive() (*lddljson.InfoWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var infoRes lddljson.InfoWalletResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetInfo() (*lddljson.InfoWalletResult, error) {
...
func (r FutureGetStakeInfoResult) Receive() (*lddljson.GetStakeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes lddljson.GetStakeInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetStakeInfoAsync() FutureGetStakeInfoResult {
	cmd := lddljson.NewGetStakeInfoCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetStakeInfo() (*lddljson.GetStakeInfoResult, error) {
...
func (r FutureGetTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	var tixRes lddljson.GetTicketsResult
...
func (c *Client) GetTicketsAsync(includeImmature bool) FutureGetTicketsResult {
	cmd := lddljson.NewGetTicketsCmd(includeImmature)
	return c.sendCmd(cmd)
}
...
func (r FutureListScriptsResult) Receive() ([][]byte, error) {
	...
	var resScr lddljson.ListScriptsResult
...
func (c *Client) ListScriptsAsync() FutureListScriptsResult {
	cmd := lddljson.NewListScriptsCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTicketFeeAsync(fee lddlutil.Amount) FutureSetTicketFeeResult {
	cmd := lddljson.NewSetTicketFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTicketFee sets the ticket fee per KB amount.
func (c *Client) SetTicketFee(fee lddlutil.Amount) error {
...
func (c *Client) SetTxFeeAsync(fee lddlutil.Amount) FutureSetTxFeeResult {
	cmd := lddljson.NewSetTxFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTxFee sets the transaction fee per KB amount.
func (c *Client) SetTxFee(fee lddlutil.Amount) error {
...
// Receive waits for the response promised by the future.
func (r FutureGetVoteChoicesResult) Receive() (*lddljson.GetVoteChoicesResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var choicesRes lddljson.GetVoteChoicesResult
...
func (c *Client) SetVoteChoiceAsync(agendaID, choiceID string) FutureSetVoteChoiceResult {
	cmd := lddljson.NewSetVoteChoiceCmd(agendaID, choiceID)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureStakePoolUserInfoResult) Receive() (*lddljson.StakePoolUserInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes lddljson.StakePoolUserInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) StakePoolUserInfoAsync(addr lddlutil.Address) FutureStakePoolUserInfoResult {
	cmd := lddljson.NewStakePoolUserInfoCmd(addr.EncodeAddress())
	return c.sendCmd(cmd)
}

// StakePoolUserInfo returns a list of tickets and information about them
// that are paying to the passed address.
func (c *Client) StakePoolUserInfo(addr lddlutil.Address) (*lddljson.StakePoolUserInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureTicketsForAddressResult) Receive() (*lddljson.TicketsForAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes lddljson.TicketsForAddressResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) TicketsForAddressAsync(addr lddlutil.Address) FutureTicketsForAddressResult {
	cmd := lddljson.NewTicketsForAddressCmd(addr.EncodeAddress())
	return c.sendCmd(cmd)
}
...
// owned by the wallet.
func (c *Client) TicketsForAddress(addr lddlutil.Address) (*lddljson.TicketsForAddressResult, error) {
...
// Receive waits for the response promised by the future and returns the stake
// info provided by the server.
func (r FutureWalletInfoResult) Receive() (*lddljson.WalletInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes lddljson.WalletInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) WalletInfoAsync() FutureWalletInfoResult {
	cmd := lddljson.NewWalletInfoCmd()
	return c.sendCmd(cmd)
}

// WalletInfo returns wallet global state info for a given wallet.
func (c *Client) WalletInfo() (*lddljson.WalletInfoResult, error) {
	return c.WalletInfoAsync().Receive()
}

// TODO(davec): Implement
// backupwallet (NYI in lddlwallet)
// encryptwallet (Won't be supported by lddlwallet since it's always encrypted)
// getwalletinfo (NYI in lddlwallet or lddljson)
// listaddressgroupings (NYI in lddlwallet)
// listreceivedbyaccount (NYI in lddlwallet)

// DUMP
// importwallet (NYI in lddlwallet)
// dumpwallet (NYI in lddlwallet)

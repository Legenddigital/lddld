...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := lddljson.NewGetBestBlockHashCmd()
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := lddljson.NewGetBlockCmd(hash, lddljson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockVerboseResult) Receive() (*lddljson.GetBlockVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockResult lddljson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash, verboseTx bool) FutureGetBlockVerboseResult {
	...
	cmd := lddljson.NewGetBlockCmd(hash, lddljson.Bool(true), &verboseTx)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash, verboseTx bool) (*lddljson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := lddljson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := lddljson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := lddljson.NewGetBlockHashCmd(blockHeight)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(hash *chainhash.Hash) FutureGetBlockHeaderResult {
	cmd := lddljson.NewGetBlockHeaderCmd(hash.String(), lddljson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*lddljson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var bh lddljson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(hash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	cmd := lddljson.NewGetBlockHeaderCmd(hash.String(), lddljson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(hash *chainhash.Hash) (*lddljson.GetBlockHeaderVerboseResult, error) {
...
func (r FutureGetBlockSubsidyResult) Receive() (*lddljson.GetBlockSubsidyResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal the result
	var bs lddljson.GetBlockSubsidyResult
...
func (c *Client) GetBlockSubsidyAsync(height int64, voters uint16) FutureGetBlockSubsidyResult {
	cmd := lddljson.NewGetBlockSubsidyCmd(height, voters)
	return c.sendCmd(cmd)
}

// GetBlockSubsidy returns a data structure of the block subsidy
// from the server given its height and number of voters.
func (c *Client) GetBlockSubsidy(height int64, voters uint16) (*lddljson.GetBlockSubsidyResult, error) {
...
// Receive waits for the response promised by the future and returns the
// current coin supply
func (r FutureGetCoinSupplyResult) Receive() (lddlutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetCoinSupplyAsync() FutureGetCoinSupplyResult {
	cmd := lddljson.NewGetCoinSupplyCmd()
	return c.sendCmd(cmd)
}

// GetCoinSupply returns the current coin supply
func (c *Client) GetCoinSupply() (lddlutil.Amount, error) {
...
func (c *Client) GetRawMempoolAsync(txType lddljson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolResult {
	cmd := lddljson.NewGetRawMempoolCmd(lddljson.Bool(false),
		lddljson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempool(txType lddljson.GetRawMempoolTxTypeCmd) ([]*chainhash.Hash, error) {
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]lddljson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]lddljson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync(txType lddljson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolVerboseResult {
	cmd := lddljson.NewGetRawMempoolCmd(lddljson.Bool(true),
		lddljson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose(txType lddljson.GetRawMempoolTxTypeCmd) (map[string]lddljson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := lddljson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int64) FutureVerifyChainResult {
	cmd := lddljson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int64) FutureVerifyChainResult {
	cmd := lddljson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*lddljson.GetTxOutResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *lddljson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := lddljson.NewGetTxOutCmd(hash, index, &mempool)
	return c.sendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*lddljson.GetTxOutResult, error) {
...
func (r FutureRescanResult) Receive() (*lddljson.RescanResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanResult *lddljson.RescanResult
...
func (c *Client) RescanAsync(blockHashes []chainhash.Hash) FutureRescanResult {
	...
	cmd := lddljson.NewRescanCmd(hex.EncodeToString(concatenatedBlockHashes))
	return c.sendCmd(cmd)
}
...
func (c *Client) Rescan(blockHashes []chainhash.Hash) (*lddljson.RescanResult, error) {
...
func (c *Client) GetCFilterAsync(blockHash *chainhash.Hash, filterType wire.FilterType) FutureGetCFilterResult {
	...
	cmd := lddljson.NewGetCFilterCmd(blockHash.String(), ft)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCFilterHeaderAsync(blockHash *chainhash.Hash, filterType wire.FilterType) FutureGetCFilterHeaderResult {
	...
	cmd := lddljson.NewGetCFilterHeaderCmd(blockHash.String(), ft)
	return c.sendCmd(cmd)
}

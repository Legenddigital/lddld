...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, LDDLD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawsstx-amount--desc":  "The destination address as the key and the amount in LDDL as the value",
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in LDDL as the value",
	...
	"scriptpubkeyresult-addresses": "The Legenddigital addresses associated with this script",
	"scriptpubkeyresult-commitamt": "The ticket commitment value if the script is for a staking commitment",

	// Vout help.
	"vout-value":        "The amount in LDDL",
	...
	"decodescriptresult-addresses": "The Legenddigital addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (lddld extension)",
	...
	"getcurrentnet--synopsis": "Get Legenddigital network the server is running on.",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in LDDL/KB",
	...
	"infowalletresult-balance":         "The total Legenddigital balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in LDDL/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in LDDL/KB",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in Legenddigital",
	...
	"gettxoutresult-value":         "The transaction amount in LDDL",
	...
	"searchrawtransactions-address":     "The Legenddigital address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (lddld does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown lddld.",
	"stop--result0":  "The string 'lddld stopping.'",
	...
	"validateaddresschainresult-address": "The Legenddigital address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Legenddigital address to validate",
	...
	"verifymessage-address":   "The Legenddigital address to use for the signature",
	...
	// -------- Legenddigital-specific help --------

	// EstimateFee help.
	"estimatefee--synopsis": "Returns the estimated fee in lddl/kb.",
	...
	// TicketFeeInfo help.
	"ticketfeeinfo--synopsis":            "Get various information about ticket fees from the mempool, blocks, and difficulty windows (units: LDDL/kB)",
	...
	"ticketfeeinforesult-feeinfomempool": "Ticket fee information for all tickets in the mempool (units: LDDL/kB)",
	"ticketfeeinforesult-feeinfoblocks":  "Ticket fee information for a given list of blocks descending from the chain tip (units: LDDL/kB)",
	"ticketfeeinforesult-feeinfowindows": "Ticket fee information for a window period where the stake difficulty was the same (units: LDDL/kB)",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*lddljson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*lddljson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"estimatestakediff":     {(*lddljson.EstimateStakeDiffResult)(nil)},
	...
	"getaddednodeinfo":      {(*[]string)(nil), (*[]lddljson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*lddljson.GetBestBlockResult)(nil)},
	"generate":              {(*[]string)(nil)},
	"getbestblockhash":      {(*string)(nil)},
	"getblock":              {(*string)(nil), (*lddljson.GetBlockVerboseResult)(nil)},
	"getblockcount":         {(*int64)(nil)},
	"getblockhash":          {(*string)(nil)},
	"getblockheader":        {(*string)(nil), (*lddljson.GetBlockHeaderVerboseResult)(nil)},
	"getblocksubsidy":       {(*lddljson.GetBlockSubsidyResult)(nil)},
	"getblocktemplate":      {(*lddljson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getcfilter":            {(*string)(nil)},
	"getcfilterheader":      {(*string)(nil)},
	"getchaintips":          {(*[]lddljson.GetChainTipsResult)(nil)},
	"getconnectioncount":    {(*int32)(nil)},
	"getcurrentnet":         {(*uint32)(nil)},
	"getdifficulty":         {(*float64)(nil)},
	"getstakedifficulty":    {(*lddljson.GetStakeDifficultyResult)(nil)},
	"getstakeversioninfo":   {(*lddljson.GetStakeVersionInfoResult)(nil)},
	"getstakeversions":      {(*lddljson.GetStakeVersionsResult)(nil)},
	"getgenerate":           {(*bool)(nil)},
	"gethashespersec":       {(*float64)(nil)},
	"getheaders":            {(*lddljson.GetHeadersResult)(nil)},
	"getinfo":               {(*lddljson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*lddljson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*lddljson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*lddljson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]lddljson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*lddljson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*lddljson.TxRawResult)(nil)},
	"getticketpoolvalue":    {(*float64)(nil)},
	"gettxout":              {(*lddljson.GetTxOutResult)(nil)},
	"getvoteinfo":           {(*lddljson.GetVoteInfoResult)(nil)},
	"getwork":               {(*lddljson.GetWorkResult)(nil), (*bool)(nil)},
	"getcoinsupply":         {(*int64)(nil)},
	"help":                  {(*string)(nil), (*string)(nil)},
	"livetickets":           {(*lddljson.LiveTicketsResult)(nil)},
	"missedtickets":         {(*lddljson.MissedTicketsResult)(nil)},
	"node":                  nil,
	"ping":                  nil,
	"rebroadcastmissed":     nil,
	"rebroadcastwinners":    nil,
	"searchrawtransactions": {(*string)(nil), (*[]lddljson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"ticketfeeinfo":         {(*lddljson.TicketFeeInfoResult)(nil)},
	"ticketsforaddress":     {(*lddljson.TicketsForAddressResult)(nil)},
	"ticketvwap":            {(*float64)(nil)},
	"txfeeinfo":             {(*lddljson.TxFeeInfoResult)(nil)},
	"validateaddress":       {(*lddljson.ValidateAddressChainResult)(nil)},
	"verifychain":           {(*bool)(nil)},
	"verifymessage":         {(*bool)(nil)},
	"version":               {(*map[string]lddljson.VersionResult)(nil)},

	// Websocket commands.
	"loadtxfilter":                nil,
	"session":                     {(*lddljson.SessionResult)(nil)},
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := lddljson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := lddljson.MethodUsageText(k)
		if err != nil {
			return "", err
		}

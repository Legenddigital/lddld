...
var (
	...
	// mainPowLimit is the highest proof of work value a Legenddigital block can
	// have for the main network.  It is the value 2^224 - 1.
	mainPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 224), bigOne)

	// testNetPowLimit is the highest proof of work value a Legenddigital block
	// can have for the test network.  It is the value 2^232 - 1.
	testNetPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 232), bigOne)

	// simNetPowLimit is the highest proof of work value a Legenddigital block
...
// Params defines a Legenddigital network by its parameters.  These parameters may be
// used by Legenddigital applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Ticket pool sizes for Legenddigital PoS. This denotes the number of possible
	...
	// Average number of tickets per block for Legenddigital PoS.
...
var (
	// ErrDuplicateNet describes an error where the parameters for a Legenddigital
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate Legenddigital network")
...
// Register registers the network parameters for a Legenddigital network.  This may

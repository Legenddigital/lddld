...
// MainNetParams defines the network parameters for the main Legenddigital network.
var MainNetParams = Params{
	Name:        "mainnet",
	Net:         wire.MainNet,
	DefaultPort: "9108",
	DNSSeeds: []DNSSeed{
		{"mainnet-seed.Legenddigital.minlddly.org", true},
		{"mainnet-seed.Legenddigital.netpurgatory.com", true},
		{"mainnet-seed.Legenddigital.org", true},
	},
	...
	// address generation.
	SLIP0044CoinType: 42, // SLIP0044, Legenddigital
	LegacyCoinType:   20, // for backwards compatibility

	// Legenddigital PoS parameters
	...
	// Legenddigital organization related parameters

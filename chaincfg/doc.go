...
//
// In addition to the main Legenddigital network, which is intended for the transfer
...
// wire.LegenddigitalNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := lddlutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the three standard Legenddigital networks,

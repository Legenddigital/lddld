...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := lddlutil.Hash160(k.pubKeyBytes())[:4]
...
// ECPubKey converts the extended key to a lddlec public key and returns it.
func (k *ExtendedKey) ECPubKey() (*secp256k1.PublicKey, error) {
	return secp256k1.ParsePubKey(k.pubKeyBytes())
}

// ECPrivKey converts the extended key to a lddlec private key and returns it.
...
// Address converts the extended key to a standard Legenddigital pay-to-pubkey-hash
// address for the passed network.
func (k *ExtendedKey) Address(net *chaincfg.Params) (*lddlutil.AddressPubKeyHash, error) {
	pkHash := lddlutil.Hash160(k.pubKeyBytes())
	return lddlutil.NewAddressPubKeyHash(pkHash, net, lddlec.STEcdsaSecp256k1)
}

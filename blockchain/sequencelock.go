...
func (b *BlockChain) calcSequenceLock(node *blockNode, tx *lddlutil.Tx, view *UtxoViewpoint, isActive bool) (*SequenceLock, error) {
...
func (b *BlockChain) CalcSequenceLock(tx *lddlutil.Tx, view *UtxoViewpoint) (*SequenceLock, error) {
	b.chainLock.Lock()

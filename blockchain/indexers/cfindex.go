...
func storeFilter(dbTx database.Tx, block *lddlutil.Block, f *gcs.Filter, filterType wire.FilterType) error {
...
func (idx *CFIndex) ConnectBlock(dbTx database.Tx, block, parent *lddlutil.Block, view *blockchain.UtxoViewpoint) error {
...
func (idx *CFIndex) DisconnectBlock(dbTx database.Tx, block, parent *lddlutil.Block, view *blockchain.UtxoViewpoint) error {

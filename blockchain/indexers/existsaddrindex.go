...
func (idx *ExistsAddrIndex) ExistsAddress(addr lddlutil.Address) (bool, error) {
...
func (idx *ExistsAddrIndex) ExistsAddresses(addrs []lddlutil.Address) ([]bool, error) {
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) ConnectBlock(dbTx database.Tx, block, parent *lddlutil.Block, view *blockchain.UtxoViewpoint) error {
	var parentTxs []*lddlutil.Tx
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) DisconnectBlock(dbTx database.Tx, block, parent *lddlutil.Block, view *blockchain.UtxoViewpoint) error {
	return nil
}

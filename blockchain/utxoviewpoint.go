...
func (view *UtxoViewpoint) AddTxOuts(tx *lddlutil.Tx, blockHeight int64, blockIndex uint32) {
	msgTx := tx.MsgTx()
...
func (view *UtxoViewpoint) connectTransaction(tx *lddlutil.Tx, blockHeight int64, blockIndex uint32, stxos *[]spentTxOut) error {
	msgTx := tx.MsgTx()
...
func (b *BlockChain) connectTransactions(view *UtxoViewpoint, block *lddlutil.Block, parent *lddlutil.Block, stxos *[]spentTxOut) error {
...
func (b *BlockChain) disconnectTransactions(view *UtxoViewpoint, block *lddlutil.Block, parent *lddlutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactionSlice(transactions []*lddlutil.Tx, height int64, stxosPtr *[]spentTxOut) (int, error) {
	if stxosPtr == nil {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block, parent *lddlutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *lddlutil.Tx, treeValid bool) (*UtxoViewpoint, error) {
	b.chainLock.RLock()

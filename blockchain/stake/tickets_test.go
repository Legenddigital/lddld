...
import (
	...
	"github.com/Legenddigital/lddld/blockchain/stake/internal/tickettreap"
...
func ticketsInBlock(bl *lddlutil.Block) []chainhash.Hash {
...
func TestTicketDBLongChain(t *testing.T) {
	...
	testBlockchain := make(map[int64]*lddlutil.Block, len(testBlockchainBytes))
	for k, v := range testBlockchainBytes {
		bl, err := lddlutil.NewBlockFromBytes(v)
		if err != nil {

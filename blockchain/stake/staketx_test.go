...
func TestSStx(t *testing.T) {
	var sstx = lddlutil.NewTx(sstxMsgTx)
	...
	sstx = lddlutil.NewTxDeep(sstxMsgTx)
...
func TestSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = lddlutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = lddlutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = lddlutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = lddlutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = lddlutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = lddlutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = lddlutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = lddlutil.NewTx(&tx)
	...
	var sstxWrongPrefix = lddlutil.NewTx(&tx)
...
func TestSSGen(t *testing.T) {
	var ssgen = lddlutil.NewTx(ssgenMsgTx)
	...
	ssgen = lddlutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = lddlutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = lddlutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = lddlutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = lddlutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = lddlutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = lddlutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = lddlutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = lddlutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = lddlutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = lddlutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = lddlutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = lddlutil.NewTx(&tx)
...
func TestSSRtx(t *testing.T) {
	var ssrtx = lddlutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = lddlutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = lddlutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = lddlutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = lddlutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = lddlutil.NewTx(&tx)
...
func TestVerifyRealTxs(t *testing.T) {
	...
	ssrtxTx := lddlutil.NewTx(ssrtxMtx)

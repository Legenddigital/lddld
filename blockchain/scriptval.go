...
func ValidateTransactionScripts(tx *lddlutil.Tx, utxoView *UtxoViewpoint, flags txscript.ScriptFlags, sigCache *txscript.SigCache) error {
...
func checkBlockScripts(block *lddlutil.Block, utxoView *UtxoViewpoint, txTree bool,

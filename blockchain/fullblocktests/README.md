...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Legenddigital/lddld/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/Legenddigital/lddld/blockchain/fullblocktests
```

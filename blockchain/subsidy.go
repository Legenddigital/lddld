...
func BlockOneCoinbasePaysTokens(tx *lddlutil.Tx, params *chaincfg.Params) error {
	...
	for i, txout := range tx.MsgTx().TxOut {
		...
		addrLedger, err := lddlutil.DecodeAddress(ledger[i].Address)
		if err != nil {
			return err
		}
...
func CoinbasePaysTax(subsidyCache *SubsidyCache, tx *lddlutil.Tx, height int64, voters uint16, params *chaincfg.Params) error {
...
func CalculateAddedSubsidy(block, parent *lddlutil.Block) int64 {
	var subsidy int64

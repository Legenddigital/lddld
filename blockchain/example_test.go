...
// overview documentation describes, this includes all of the Legenddigital consensus
...
func ExampleBlockChain_ProcessBlock() {
	...
	// exists.
	genesisBlock := lddlutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
...
func ExampleCompactToBig() {
	// Convert the bits from block 300000 in the main Legenddigital block chain.

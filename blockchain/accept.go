...
// impossible.
func checkCoinbaseUniqueHeight(blockHeight int64, block *lddlutil.Block) error {
...
func IsFinalizedTransaction(tx *lddlutil.Tx, blockHeight int64, blockTime time.Time) bool {
...
func (b *BlockChain) maybeAcceptBlock(block *lddlutil.Block, flags BehaviorFlags) (int64, error) {

...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Legenddigital/lddld/blockchain/chaingen)
...
* [Basic Usage Example]
  (http://godoc.org/github.com/Legenddigital/lddld/blockchain/chaingen#example-package--BasicUsage)  
...
```bash
$ go get -u github.com/Legenddigital/lddld/blockchain/chaingen
```

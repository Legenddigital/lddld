...
// Peer provides a basic concurrent safe Legenddigital peer for handling Legenddigital
...
// callbacks for handling Legenddigital protocol messages.
//
...
// newPeerBase returns a new base Legenddigital peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound Legenddigital peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound Legenddigital peer.

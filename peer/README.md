...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Legenddigital/lddld/peer)
...
```bash
$ go get -u github.com/Legenddigital/lddld/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/Legenddigital/lddld/peer#example-package--NewOutboundPeer)  

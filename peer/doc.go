...
/*
Package peer provides a common base for creating and managing Legenddigital network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the Legenddigital wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe Legenddigital peer for handling Legenddigital
   communications via the peer-to-peer protocol
 - Full duplex reading and writing of Legenddigital protocol messages
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling Legenddigital protocol messages
...
caller to specify things such as the user agent name and version, the Legenddigital
network to use, which services it supports, and callbacks to invoke when Legenddigital
...
In order to do anything useful with a peer, it is necessary to react to Legenddigital
...
For convenience, a callback hook for all of the currently supported Legenddigital
...
(https://godoc.org/github.com/Legenddigital/lddld/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer

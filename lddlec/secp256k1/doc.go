...
/*
Package secp256k1 implements support for the elliptic curves needed for Legenddigital.

Legenddigital uses elliptic curve cryptography using koblitz curves
...
standard formats.  It was designed for use with lddld, but should be

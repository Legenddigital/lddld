...
/*
Package txscript implements the Legenddigital transaction script language.

This package provides data structures and functions to parse and execute
Legenddigital transaction scripts.

Script Overview

Legenddigital transaction scripts are written in a stack-base, FORTH-like language.

The Legenddigital script language consists of a number of opcodes which fall into
...
The vast majority of Legenddigital scripts at the time of this writing are of several
...
what conditions must be met in order to spend Legenddigitals.

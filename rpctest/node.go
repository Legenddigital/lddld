...
// arguments returns an array of arguments that be used to launch the lddld
// process.
...
// to the lddld process that is launched via Start().
...
func (n *node) start() error {
	...
	pid, err := os.Create(filepath.Join(n.config.String(), "lddld.pid"))
	if err != nil {
		return err
	}
...
// stop interrupts the running lddld process process, and waits until it exits
...
// shutdown terminates the running lddld process, and cleans up all

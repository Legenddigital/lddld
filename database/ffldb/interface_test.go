...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.CurrencyNet) ([]*lddlutil.Block, error) {
	...
	blocks := make([]*lddlutil.Block, 169)
	for i := 0; i <= 168; i++ {
		bl, err := lddlutil.NewBlockFromBytes(blockChain[int64(i)])
		if err != nil {

...
/*
Package addrmgr implements concurrency safe Legenddigital address manager.

Address Manager Overview

In order maintain the peer-to-peer Legenddigital network, there needs to be a source
of addresses to connect to as nodes come and go.  The Legenddigital protocol provides

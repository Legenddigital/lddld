...
func TestAmountMulF64(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Multiply 0.1 LDDL by 2",
			amt:  100e5, // 0.1 LDDL
			mul:  2,
			res:  200e5, // 0.2 LDDL
		},
		{
			name: "Multiply 0.2 LDDL by 0.02",
			amt:  200e5, // 0.2 LDDL
			mul:  1.02,
			res:  204e5, // 0.204 LDDL
		},
		{
			name: "Multiply 0.1 LDDL by -2",
			amt:  100e5, // 0.1 LDDL

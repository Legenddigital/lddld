...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Legenddigital/lddld/lddlutil/txsort)
...
differences with Legenddigital-specific transactions.
...
```bash
$ go get -u github.com/Legenddigital/lddld/lddlutil/txsort
```

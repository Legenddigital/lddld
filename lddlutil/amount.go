...
// units, "1eN LDDL" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " LDDL"
	}
}
...
//
// NewAmount is for specifically for converting LDDL to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/Legenddigital/lddld/lddlutil#example-Amount
...
// useful for services that build on top of Legenddigital (for example, calculating

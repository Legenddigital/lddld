...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Legenddigital/lddld/mempool)

Package mempool provides a policy-enforced pool of unmined Legenddigital transactions.

A key responsibility of the Legenddigital network is mining transactions – regular
...
Since this package does not deal with other Legenddigital specifics such as network
...
package for any projects needing the ability create an in-memory pool of Legenddigital
...
```bash
$ go get -u github.com/Legenddigital/lddld/mempool
```

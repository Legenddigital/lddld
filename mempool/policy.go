...
const (
	...
	DefaultMinRelayTxFee = lddlutil.Amount(1e4)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee lddlutil.Amount) int64 {
	...
	if minFee < 0 || minFee > lddlutil.MaxAmount {
		minFee = lddlutil.MaxAmount
	}
...
func checkInputsStandard(tx *lddlutil.Tx, txType stake.TxType, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee lddlutil.Amount) bool {
...
func checkTransactionStandard(tx *lddlutil.Tx, txType stake.TxType, height int64,
	medianTime time.Time, minRelayTxFee lddlutil.Amount,

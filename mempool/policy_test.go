...
func TestCalcMinRequiredTxRelayFee(t *testing.T) {
	tests := []struct {
		...
		relayFee lddlutil.Amount // minimum relay transaction fee.
...
func TestDust(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wire.TxOut{Value: lddlutil.MaxAmount, Version: 0, PkScript: pkScript},
			lddlutil.MaxAmount,
			false,
		},
		{
...
func TestCheckTransactionStandard(t *testing.T) {
	...
	addr, err := lddlutil.NewAddressPubKeyHash(addrHash[:],
		&chaincfg.SimNetParams, lddlec.STEcdsaSecp256k1)
	if err != nil {

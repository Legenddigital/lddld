...
/*
lddld is a full-node Legenddigital implementation written in Go.

The default options are sane for most users.  This means lddld will work 'out of
...
parsed when lddld starts up.  By default, the configuration file is located at
~/.lddld/lddld.conf on POSIX-style operating systems and %LOCALAPPDATA%\lddld\lddld.conf
...
Application Options:
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in LDDL/kB to be

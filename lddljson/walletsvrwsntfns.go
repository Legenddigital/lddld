...
const (
	...
	// LddldConnectedNtfnMethod is the method used for notifications when
	// a wallet server is connected to a chain server.
	LddldConnectedNtfnMethod = "lddldconnected"
	...
	// RevocationCreatedNtfnMethod is the method of the lddlwallet
	...
	// TicketPurchasedNtfnMethod is the method of the lddlwallet
	// ticketpurchased notification.
	TicketPurchasedNtfnMethod = "ticketpurchased"

	// VoteCreatedNtfnMethod is the method of the lddlwallet
...
// LddldConnectedNtfn defines the lddlddconnected JSON-RPC notification.
type LddldConnectedNtfn struct {
	Connected bool
}

// NewLddldConnectedNtfn returns a new instance which can be used to issue a
// lddlddconnected JSON-RPC notification.
func NewLddldConnectedNtfn(connected bool) *LddldConnectedNtfn {
	return &LddldConnectedNtfn{
		Connected: connected,
	}
}
...
func init() {
	...
	MustRegisterCmd(LddldConnectedNtfnMethod, (*LddldConnectedNtfn)(nil), flags)

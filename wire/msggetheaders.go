...
// MsgGetHeaders implements the Message interface and represents a Legenddigital
...
// NewMsgGetHeaders returns a new Legenddigital getheaders message that conforms to

...
// MsgPing implements the Message interface and represents a Legenddigital ping
// message.
//
...
// NewMsgPing returns a new Legenddigital ping message that conforms to the Message

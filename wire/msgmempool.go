...
// MsgMemPool implements the Message interface and represents a Legenddigital mempool
...
// NewMsgMemPool returns a new Legenddigital pong message that conforms to the Message

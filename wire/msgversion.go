...
const DefaultUserAgent = "/lddlwire:0.3.0/"

// MsgVersion implements the Message interface and represents a Legenddigital version
...
// NewMsgVersion returns a new Legenddigital version message that conforms to the
...
// and local address from conn and returns a new Legenddigital version message that

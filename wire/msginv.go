...
// MsgInv implements the Message interface and represents a Legenddigital inv message.
...
// NewMsgInv returns a new Legenddigital inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new Legenddigital inv message that conforms to the

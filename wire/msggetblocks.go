...
// MsgGetBlocks implements the Message interface and represents a Legenddigital
...
// NewMsgGetBlocks returns a new Legenddigital getblocks message that conforms to the

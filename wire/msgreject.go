...
// MsgReject implements the Message interface and represents a Legenddigital reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	// Unfortunately the Legenddigital protocol does not enforce a sane
...
// NewMsgReject returns a new Legenddigital reject message that conforms to the

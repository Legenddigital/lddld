...
// MsgGetData implements the Message interface and represents a Legenddigital
...
// NewMsgGetData returns a new Legenddigital getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new Legenddigital getdata message that conforms to

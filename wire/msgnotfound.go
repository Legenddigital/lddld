...
// MsgNotFound defines a Legenddigital notfound message which is sent in response to
...
// NewMsgNotFound returns a new Legenddigital notfound message that conforms to the

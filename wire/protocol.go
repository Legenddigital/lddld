...
// ServiceFlag identifies services supported by a Legenddigital peer.
...
// CurrencyNet represents which Legenddigital network a message belongs to.
type CurrencyNet uint32

// Constants used to indicate the message Legenddigital network.  They can also be
// used to seek to the next message when a stream's state is unknown, but
// this package does not provide that functionality since it's generally a
// better idea to simply disconnect clients that are misbehaving over TCP.
const (
	// MainNet represents the main Legenddigital network.
...
// bnStrings is a map of Legenddigital networks back to their constant names for
// pretty printing.

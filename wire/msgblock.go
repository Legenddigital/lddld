...
// MsgBlock implements the Message interface and represents a Legenddigital
...
// BtcDecode decodes from the Legenddigital wire protocol as it was sent across the
...
// the Legenddigital wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new Legenddigital block message that conforms to the

...
// MsgGetAddr implements the Message interface and represents a Legenddigital
...
// NewMsgGetAddr returns a new Legenddigital getaddr message that conforms to the

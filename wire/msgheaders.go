...
// a single Legenddigital headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a Legenddigital headers
...
// NewMsgHeaders returns a new Legenddigital headers message that conforms to the

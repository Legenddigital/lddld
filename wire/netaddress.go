...
// maxNetAddressPayload returns the max payload size for a Legenddigital NetAddress
...
type NetAddress struct {
	...
	// not present in the Legenddigital version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The Legenddigital protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Legenddigital protocol mixes little and big endian.
